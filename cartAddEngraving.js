Ecwid.OnAPILoaded.add(function() {
    Ecwid.OnPageLoaded.add(function(page) {
      ...
      if (page.type === 'PRODUCT') {
          ...
          var basePrices = {55001151: 119.95, 74102380: 131.95, 506210440: 136.95, 570262509: 119.95, 94782479: 71.00};
          ...
          function updatePrice() {
              var engravingText1 = engravingInput1 ? engravingInput1.value : '';
              var engravingText2 = engravingInput2 ? engravingInput2.value : '';
              ...
              var charCount = engravingText1.length + engravingText2.length;
              var engravingCost = ind[charCount];
  
              // Update the displayed price
              var priceElement = document.querySelector('.details-product-price__value.ec-price-item.notranslate');
              var gripPrice = (gripColorValue === 'Cork') ? 14 : 0;
              var strapPrice;
              ...
              var newPrice = basePrice + engravingCost + gripPrice + strapPrice;
          ...
          function handleAddToCart(event) {
              ...
              var engravingText2 = engravingInput2 ? engravingInput2.value : '';
              var charCount = engravingText1.length + engravingText2.length;
              var engravingCost = customEngraving[charCount];
              ...
              var quantityValue = quantityCheck ? parseInt(quantityCheck.value, 10) : 1;
